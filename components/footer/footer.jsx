      ...
      <FooterWrap>
        <div style={{'display':'flex'}}>
            <div style={{'display':'grid', maxWidth:"500px", minWidth:"200px"}}> 
                <div style={{'display':'flex'}}>
                    <Input style={{component:"input", style:{'display':'grid',justifyItems:"let"}}} type="text" name="name" id="footerName" location={"footer"} placeholder="name"/>
                    <Input style={{component:"input", style:{'display':'grid',justifyItems:"right"}}} type="email" name="name" id="footerEmail" location={"footer"} placeholder="email"/>
                </div>
